...
print("Climbing Stairs() =", climbing_stairs()())
print()

print(f"Climbing Stairs('test') = {climbing_stairs()(stairNum='test')}")
print(f"Climbing Stairs(-1) = {climbing_stairs()(stairNum=-1)}")
print(f"Climbing Stairs(55) = {climbing_stairs()(stairNum=55)}")
print()

print(f"Climbing Stairs(1) = {climbing_stairs()(stairNum=1)}")
print(f"Climbing Stairs(2) = {climbing_stairs()(stairNum=2)}")
print(f"Climbing Stairs(3) = {climbing_stairs()(stairNum=3)}")
print()

stair_num: int = random.randint(1, 45)
print(f"Climbing Stairs({stair_num}) = {climbing_stairs()(stairNum=stair_num)}")
print()
